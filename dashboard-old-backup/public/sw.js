// Copyright 2026 AeroFyta — Service Worker for PWA offline support.
// Strategy: cache-first for static assets, network-first for API calls.

const CACHE_NAME = 'aerofyta-v2';
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/offline.html',
...
self.addEventListener('fetch', (event) => {
  ...
  // API calls & SSE: network-first, fall back to cache
  ...
  if (
    url.pathname.match(/\.(js|css|svg|png|jpg|jpeg|webp|woff2?|ttf|eot|ico)$/) ||
