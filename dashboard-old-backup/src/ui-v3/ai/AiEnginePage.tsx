    ...
    <div>
      ...
      <section className="mb-6">
        <h2 className="flex items-center gap-2 text-base font-bold text-white mb-4 tracking-tight" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
          <Sparkles className="w-4 h-4 text-[#85c742]" />
          Innovation
        </h2>
      ...
      <details className="group rounded-xl bg-zinc-900/30 border border-[rgba(136,146,176,0.15)]/50">
        <summary className="flex items-center justify-between cursor-pointer px-5 py-4 text-sm font-semibold text-[#8892b0] hover:text-white transition-colors select-none">
