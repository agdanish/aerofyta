...
export function SettingsPage({ theme, onToggleTheme, soundOn, onToggleSound, totalTips, onWalletChanged }: SettingsPageProps) {
  return (
    <div>
      ...
      {/* ── ACCOUNT & PREFERENCES ── */}
      <SettingsSection icon={Settings} iconColor="bg-[rgba(136,146,176,0.15)] text-[#8892b0]" title="Account & Preferences" subtitle="Agent personality, defaults, theme" first>
      ...
      {/* ── SYSTEM HEALTH ── */}
      <SettingsSection icon={Shield} iconColor="bg-lime-900/50 text-[#85c742]" title="System Health" subtitle="Service status and monitoring">
        <HealthDashboard />
      ...
      <div className="mb-6 pt-8 border-t border-[rgba(136,146,176,0.15)]/50">
        <details className="group rounded-xl bg-zinc-900/30 border border-[rgba(136,146,176,0.15)]/50">
          <summary className="flex items-center gap-3 cursor-pointer px-5 py-4 select-none">
            ...
            <span className="text-sm font-bold text-[#8892b0] hover:text-white transition-colors flex-1">Integrations & Webhooks</span>
      ...
      <div className="mb-6">
        <details className="group rounded-xl bg-zinc-900/30 border border-[rgba(136,146,176,0.15)]/50">
          <summary className="flex items-center gap-3 cursor-pointer px-5 py-4 select-none">
            ...
            <span className="text-sm font-bold text-[#8892b0] hover:text-white transition-colors flex-1">Developer Tools</span>
            <svg className="w-4 h-4 text-zinc-500 transition-transform duration-200 group-open:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
          </summary>
          <div className="px-5 pb-5 space-y-5 animate-slide-down">
            <ApiDocs />
