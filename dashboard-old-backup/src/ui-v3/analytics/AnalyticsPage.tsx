  ...
  return (
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-neutral-500 mt-1">Tipping performance, chain economics, and engagement insights</p>
      </div>
      ...
      <details className="group rounded-xl bg-neutral-900/30 border border-neutral-800/50">
        <summary className="flex items-center justify-between cursor-pointer px-5 py-4 text-sm font-semibold text-neutral-300 hover:text-white transition-colors select-none">
          <span>Gamification & Tech Stack</span>
          <svg className="w-4 h-4 text-neutral-500 transition-transform duration-200 group-open:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
        </summary>
