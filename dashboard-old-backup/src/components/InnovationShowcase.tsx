...
const innovations: Innovation[] = [
  ...
  { icon: <FileText className="w-5 h-5" />, title: 'Proof-of-Tip Receipts', tagline: 'SHA-256 signed cryptographic proof of every tip', tab: 'settings', color: 'text-orange-400' },
  ...
  { icon: <Database className="w-5 h-5" />, title: 'Agent Memory', tagline: 'Persistent learning with confidence-scored memories', tab: 'ai', color: 'text-amber-400' },
        ...
        <div className="scroll-snap-x flex gap-3 pb-2 -mx-1 px-1">
          {innovations.map((item, i) => (
            <button
              ...
              className="scroll-snap-item shrink-0 w-[180px] p-3 rounded-lg bg-neutral-800/40 border border-neutral-700/40 hover:border-neutral-600 text-left group transition-colors animate-list-item-in"
