const techBadges = [
  ...
  { name: 'React 19', color: 'bg-orange-500/15 text-orange-400 border-orange-500/25' },
  ...
  { name: 'Tether WDK', color: 'bg-lime-500/15 text-lime-400 border-lime-500/25' },
  { name: 'Express 5', color: 'bg-gray-500/15 text-gray-400 border-gray-500/25' },
  { name: 'ethers.js', color: 'bg-amber-500/15 text-amber-400 border-amber-500/25' },
