...
export function AnalyticsDashboard() {
  ...
  const fetchAnalytics = useCallback(async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Analytics initializing — connect the agent backend');
    } finally {
      setLoading(false);
    }
  }, []);
          ...
          {data && (
            <>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2">
                ...
                <KpiCard label="Recipients" value={data.overview.uniqueRecipients.toString()} icon={Users} color="text-orange-400" />
              </div>
