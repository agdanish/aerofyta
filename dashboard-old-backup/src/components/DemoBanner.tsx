...
export function DemoBanner() {
  ...
  return (
    <div className="relative mb-5 rounded-xl border border-amber-500/30 bg-amber-500/5 p-4 overflow-hidden">
      ...
      <div className="relative flex flex-col sm:flex-row sm:items-center gap-3">
        ...
        <button
          ...
          className="absolute top-3 right-3 sm:static p-1.5 rounded-md text-neutral-500 hover:text-white hover:bg-neutral-800 transition-colors"
      ...
      <div className="relative mt-3 flex flex-col sm:flex-row gap-3 text-xs">
        {/* Wallet address */}
        {address && (
          <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-neutral-900/60 border border-neutral-800/50">
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-orange-500/10 border border-orange-500/20 text-orange-400 hover:bg-orange-500/20 transition-colors"
        >
