        ...
        onTipComplete({
          ...
          decision: {
            ...
            reasoning: result.gasless
              ...
              : 'Used standard transaction — gasless mode pending activation',
            analyses: [],
            steps: [],
            confidence: 1,
          },
            ...
            >
              <span
                className={`inline-block h-3.5 w-3.5 rounded-full bg-white transition-transform ${
                  scheduleMode ? 'tranneutral-x-[18px]' : 'tranneutral-x-[3px]'
                }`}
              />
            </button>
            ...
            <div className="mt-2 space-y-2">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <span
                    className={`inline-block h-3.5 w-3.5 rounded-full bg-white transition-transform ${
                      recurring ? 'tranneutral-x-[18px]' : 'tranneutral-x-[3px]'
                    }`}
                  />
                </button>
