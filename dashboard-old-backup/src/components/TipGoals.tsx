                ...
                <div className="flex items-start justify-between mb-2">
                  ...
                  <div className="flex items-center gap-1 ml-2 shrink-0">
                    <button
                      ...
                      className="p-1 rounded-md text-text-muted hover:text-orange-400 hover:bg-orange-500/10 transition-colors"
                ...
                <div className="relative h-2.5 rounded-full bg-surface-3 overflow-hidden mb-2">
                  <div
                    className={`absolute inset-y-0 left-0 rounded-full transition-all duration-500 ${
                      pct >= 100 ? 'bg-green-500' : pct >= 75 ? 'bg-orange-400' : pct >= 50 ? 'bg-blue-400' : 'bg-accent'
                    }`}
                    style={{ width: `${pct}%` }}
                  />
                </div>
