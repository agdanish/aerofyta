...
export function WalletCard({ balance }: WalletCardProps) {
  ...
  return (
    <div className={`rounded-xl border border-neutral-800 bg-neutral-900/60 p-4 sm:p-5 hover:border-neutral-700 transition-colors ${isEth ? 'chain-gradient-eth' : isTron ? 'chain-gradient-tron' : 'chain-gradient-ton'}`}>
