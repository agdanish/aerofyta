...
export function ShareCard({ result, onClose }: ShareCardProps) {
  ...
  const shareText = `I just sent ${result.amount} ${tokenLabel} on ${chainLabel} via AeroFyta! Powered by Tether WDK.`;
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="w-full max-w-sm animate-in fade-in zoom-in duration-200">
        ...
        <div className="rounded-2xl overflow-hidden shadow-2xl border border-border">
          {/* Gradient header */}
          <div className="relative bg-gradient-to-br from-orange-600 via-blue-600 to-purple-600 p-6 text-white">
            <button
              onClick={onClose}
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm font-bold tracking-tight">AeroFyta</span>
            </div>
