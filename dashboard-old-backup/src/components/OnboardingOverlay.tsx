...
const STEPS: OnboardingStep[] = [
  {
    title: 'Welcome to AeroFyta!',
    description:
      'Your AI-powered, multi-chain payment agent built on Tether WDK. Send USDT tips across Ethereum and TON with natural language commands.',
  ...
  },
  {
    title: 'Your Wallets',
    description:
      'AeroFyta manages wallets on multiple chains simultaneously. View balances, copy addresses, and monitor your funds in real time.',
