    ...
    return (
      <div className="rounded-xl border border-border bg-surface-1 p-5">
        <div className="flex items-center gap-2 mb-4">
          <Vault className="w-5 h-5 text-orange-400" />
          ...
          <span className="flex items-center gap-1.5">
            ...
            {yields.length > 0 && (
              <span className="text-xs text-text-muted font-normal">
                ({yields.length} pools{yields[0]?.isLive ? ' — live data' : ' — pre-computed'})
              </span>
            )}
          </span>
        ...
        {strategyOpen && (
          <div className="mt-3 space-y-3 p-3 rounded-lg bg-surface-2 border border-border">
            <label className="flex items-center justify-between">
              ...
              >
                <span className={`inline-block h-3.5 w-3.5 rounded-full bg-white transition-transform ${stratEnabled ? 'tranneutral-x-4' : 'tranneutral-x-0.5'}`} />
              </button>
            </label>
            ...
            <label className="flex items-center justify-between">
              ...
              >
                <span className={`inline-block h-3.5 w-3.5 rounded-full bg-white transition-transform ${stratAutoRebalance ? 'tranneutral-x-4' : 'tranneutral-x-0.5'}`} />
              </button>
            </label>
