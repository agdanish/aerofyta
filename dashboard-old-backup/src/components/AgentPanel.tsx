                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      {isCheapest && (
                        <span className="text-xs px-1.5 py-0.5 rounded bg-orange-500/15 text-orange-400 font-medium">
                          CHEAPEST
                        </span>
                      )}
                    </div>
                    <div className="flex items-center gap-3">
                      <span className={`text-xs font-mono ${
                        isCheapest ? 'text-orange-400' : isExpensive ? 'text-red-400' : 'text-text-secondary'
                      }`}>
                        {fc.estimatedFeeUsd}
                      </span>
